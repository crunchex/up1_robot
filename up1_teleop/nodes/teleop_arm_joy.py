...
class TeleopArmJoy():
    def __init__(self):
        ...
        *****************************************************
        ...
        self.poses = rospy.get_param('~proto-demo', dict({}))
        ...
        self.button_list['a'].setSequence('go_rest')
        self.button_list['b'].setSequence('go_up')
        self.button_list['y'].setSequence('go_home')
...
class Button:
    def __init__(self, button_name, button_id, poses, updroid_servo_write):
        ...
        self.sequence = cycle(self.poses['sequence1'])
